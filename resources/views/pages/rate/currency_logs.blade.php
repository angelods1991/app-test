        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-inline pt-3">
                    ...
                    <div class="form-group">
                        <label class="radio-inline form-control-static pr-3">
                              <input type="radio" name="column_search" value="2" /> Country Name
                        </label>
                    </div>
                </div>
            </div>
  ...
  <script>
    $(function(){
        var table = $('#currencyRateLogsTable').DataTable({
          ...
          ajax:{
              type : "POST",
              url : "{{ route('currency.activity.list') }}",
              dataType : "json",
              data : function(d){
                return $.extend({}, d, {
                   _token:"{{ csrf_token() }}",
          ...
          columns: [
              ...
              { data : 'country_name'},
              { data : 'currency_rate', sClass: 'dt-body-right'},
              { data : 'edcoin_value', sClass: 'dt-body-right'},
              { data : 'updated_date'}
          ]
        });
